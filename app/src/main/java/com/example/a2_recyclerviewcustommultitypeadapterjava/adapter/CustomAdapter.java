package com.example.a2_recyclerviewcustommultitypeadapterjava.adapter;
...
import com.example.a2_recyclerviewcustommultitypeadapterjava.R;
...
public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_AVAILABLE_YES){
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_custom_layput_yes,parent,false);
